...
\title{\textbf{Diferenciální rovnice}\\\large Skripta s důrazem na rigoróznost a příklady}
...
\input{chapters/01-Úvod-do-světa-diferenciálních-rovnic} 
\input{chapters/02-Matematický-fundament}
\input{chapters/03-Základní-teorémy-teorie-ODR}
\input{chapters/04-Pokročilá-teorie-ODR}
\input{chapters/05-Teorie-Stability-Dynamických-Systémů}
\input{chapters/06-Pokročilé-Teoretické-Koncepty-a-Syntéza}
\input{chapters/07-Systém-Úrovní}
\input{chapters/08-level-1}
\input{chapters/09-level-2}
\input{chapters/10-Úroveň-3:Lineární-obyčejné-diferenciální-rovnice-2.-řádu}
